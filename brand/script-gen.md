  ...
  "scenes": [
    {
      ...
      "visual_hint": "[wskazówka wizualna dla AI generującego HTML — opisz co powinno być na ekranie, jaki typ animacji, jakie dane]"
    }
  ]
}
...
visual_hint to wskazówka, nie nakaz. AI generujący HTML może ją zinterpretować kreatywnie.
...
--- PRZYKŁAD DOBREGO SKRYPTU (dla tematu: DCA) ---

{
  ...
  "scenes": [
    ...
    },
    {
      ...
      "visual_hint": "dwa wykresy liniowe: flat 'czekam na dołek' vs rosnący 'DCA co miesiąc', wartości na końcu"
    },
    {
      "id": "scene_04",
      "type": "lesson",
    ...
    },
    {
      ...
      "subtext": null,
      "visual_hint": "numerowana lista 1-2-3, każda pozycja wchodzi z lewej ze staggered delay, pogrubione kluczowe słowo każdego kroku"
    },
    {
      "id": "scene_06",
      "type": "question",
